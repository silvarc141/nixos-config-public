{
  ...
  config = lib.mkIf config.programs.kando.enable {
    ...
    #                 type = "command";
    #                 data = {
    #                   command = writeNuScriptBinLib "close-previous-focused-window" ''
    ...
    #                 type = "command";
    #                 data = {
    #                   command = writeNuScriptBinLib "fullscreen-previous-focused-window" ''
    #                     let lastFocusedPid = sys clients | where focusHistoryID == 1 | first | get pid
    ...
    #                 type = "command";
    #                 data = {
    #                   command = writeNuScriptBinLib "float-previous-focused-window" ''
    #                     let lastFocusedPid = sys clients | where focusHistoryID == 1 | first | get pid
    ...
    #                     type = "command";
    #                     data = {
    #                       command = writeNuScriptBinLib "pin-previous-focused-window" ''
    #                         let lastFocusedPid = sys clients | where focusHistoryID == 1 | first | get pid
    ...
    #                     type = "command";
    #                     data = {
    #                       command = writeNuScriptBinLib "kill-previous-focused-window" ''
    #                         let lastFocusedPid = sys clients | where focusHistoryID == 1 | first | get pid
    ...
    #                     type = "command";
    #                     data = {
    #                       command = writeNuScriptBinLib "pseudotile-previous-focused-window" ''
    #                         let lastFocusedPid = sys clients | where focusHistoryID == 1 | first | get pid
