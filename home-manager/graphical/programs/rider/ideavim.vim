...
set surround
let g:WhichKeyDesc_surround_ys = "ys Surround"
let g:WhichKeyDesc_surround_ds = "ds Delete surrounding"
let g:WhichKeyDesc_surround_cs = "cs Change surrounding"

set multiple-cursors
nmap s <Plug>NextWholeOccurrence
xmap s <Plug>NextWholeOccurrence
omap s <Plug>NextWholeOccurrence
nmap S <Plug>AllWholeOccurrences
xmap S <Plug>AllWholeOccurrences
omap S <Plug>AllWholeOccurrences
"nmap ss <S-C-n>bv
"xmap ss <S-C-n>bv
"omap ss <S-C-n>bv
...
" "Telescope"
imap <c-t> <Action>(SearchEverywhere)
nmap <c-t> <Action>(SearchEverywhere)
vmap <c-t> <Action>(SearchEverywhere)
