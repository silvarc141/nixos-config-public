# from https://github.com/MatthewCroughan/clan-mobile
{
  modulesPath,
  pkgs,
  lib,
  ...
  nix = {
    ...
    registry.nixpkgs.flake = lib.mkForce inputs.nixpkgs-stable;
    registry.nixpkgs.to.path = lib.mkForce inputs.nixpkgs-stable;
